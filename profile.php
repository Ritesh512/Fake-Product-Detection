...
<html lang="en">
  <head>
    ...
    <title>Grp61 - User Profile</title>
    ...
    <div class="bgroles">
      <center>
        <div class="mycardstyle">
            <div class="greyarea">
                <h5> Welcome <?php echo $_SESSION['username']; ?> To Your DashBoard  </h5>
                <h6> Email: <?php echo $_SESSION['email']; ?> </h6>
                <p> <h5>Product Details</h5> <br>
                  <?php 
                    ...
                    if (mysqli_num_rows($qry_result) > 0) {
                      ...
                      echo "<tr><th>Index</th><th>Product Name</th><th>Product ID</th></tr>";
